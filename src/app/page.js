...
import { 
  Smartphone, Monitor, PenTool, TrendingUp, Video, Layers, 
  ArrowRight, Menu, X, Star, CheckCircle2, ChevronRight,
  Mail, MessageCircle, Zap, Code, Rocket, ChevronDown,
  Sparkles, Bot, Cpu, Send, Quote, Check, Play, Globe, Shield, Trophy
} from 'lucide-react';
...
const WA_LINK = "https://wa.me/8801873189853?text=Hello%20OntoRex!%20I'm%20interested%20in%20discussing%20a%20project.";
const FB_LINK = "https://www.facebook.com/share/1B2eiGuvWQ/?mibextid=wwXIfr";

// --- DATA ---
const services = [
  { title: "Mobile App Development", description: "Native and cross-platform mobile experiences built for performance and scale.", icon: <Smartphone className="w-6 h-6" />, color: "from-orange-500 to-amber-400" },
  { title: "Web Development", description: "High-converting, SEO-optimized web applications using modern frameworks.", icon: <Monitor className="w-6 h-6" />, color: "from-amber-500 to-yellow-500" },
  { title: "UI/UX Design", description: "Intuitive, beautiful, and user-centric interfaces that drive engagement.", icon: <Layers className="w-6 h-6" />, color: "from-red-500 to-orange-400" },
  { title: "Digital Marketing", description: "Data-driven strategies to scale your audience and increase revenue.", icon: <TrendingUp className="w-6 h-6" />, color: "from-orange-400 to-amber-500" },
  { title: "Video Editing", description: "Cinematic and engaging video content tailored for social media and ads.", icon: <Video className="w-6 h-6" />, color: "from-yellow-400 to-orange-500" },
  { title: "Graphic Design", description: "Striking brand identities, illustrations, and marketing materials.", icon: <PenTool className="w-6 h-6" />, color: "from-amber-400 to-yellow-500" }
];
...
const testimonials = [
  { name: "Emily Watson", role: "CEO, TechNova", text: "OntoRex transformed our vision into a stunning reality. Their attention to detail and speed of delivery is unmatched. Absolutely thrilled!", rating: 5, img: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&q=80&w=150" },
  { name: "Marcus Reed", role: "Founder, GrowthApp", text: "The mobile app they built for us increased our user retention by 40%. Highly recommend their talented and dedicated team.", rating: 5, img: "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&q=80&w=150" },
  { name: "Sophia Martinez", role: "Marketing VP, Lumina", text: "From brand design to web development, OntoRex handled everything flawlessly. They are true professionals and artists.", rating: 5, img: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&q=80&w=150" },
  { name: "James Carter", role: "CTO, NextGen", text: "Their clean code architecture and scalable solutions are exactly what we needed for our high-traffic platform. Excellent communication.", rating: 5, img: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&q=80&w=150" },
  { name: "Linda Chen", role: "Director, Innovate LLC", text: "Fast, responsive, and incredibly creative. The Rex AI estimator was surprisingly accurate too! A fantastic partner for digital growth.", rating: 5, img: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?auto=format&fit=crop&q=80&w=150" }
];

const faqs = [
  { question: "How long does it take to build a website or app?", answer: "Timelines vary heavily based on complexity. A standard business website might take 2-4 weeks, while a custom mobile application can take anywhere from 8-12 weeks from initial design to final launch." },
  { question: "Do you offer post-launch support and maintenance?", answer: "Yes! We provide 3 months of free bug-fixing and technical support after launch. We also offer ongoing monthly maintenance packages to keep your platform updated and secure." },
  { question: "What technologies and frameworks do you use?", answer: "We leverage modern, scalable tech stacks including React, Next.js, Node.js, Flutter, React Native, Tailwind CSS, and cloud platforms like AWS and Firebase to ensure your product is fast and future-proof." },
  { question: "Can you redesign or upgrade my existing digital product?", answer: "Absolutely. Our UI/UX team specializes in revamping legacy websites and applications to drastically improve user experience, conversion rates, and modern aesthetic appeal." },
  { question: "What is your pricing structure?", answer: "We offer flexible engagement models. For well-defined projects, we provide a fixed-price quote. For ongoing or evolving scopes, we can work on a dedicated team/hourly basis." }
];
    ...
    <nav className={`fixed top-0 w-full z-[60] transition-all duration-500 border-b ${
      ...
      <div className="container mx-auto px-5 lg:px-12 flex justify-between items-center">
        <a href="#" className="flex items-center gap-2 group z-50">
          ...
          <span className="text-xl font-bold tracking-tight text-white">OntoRex</span>
        </a>

        {/* Desktop Nav */}
        <div className="hidden md:flex items-center gap-8">
          {navLinks.map((link) => (
            <a key={link.name} href={link.href} className="text-sm font-medium text-neutral-300 hover:text-white transition-colors">
              {link.name}
            </a>
          ))}
          <a href={WA_LINK} target="_blank" rel="noopener noreferrer" className="px-5 py-2.5 rounded-full text-sm font-bold bg-white/10 backdrop-blur-md border border-white/20 text-white hover:bg-white hover:text-black transition-all duration-300 flex items-center gap-2 group shadow-[0_4px_14px_rgba(0,0,0,0.1)] hover:shadow-[0_0_20px_rgba(255,255,255,0.2)]">
            <WhatsAppIcon className="w-4 h-4 text-green-500 group-hover:text-green-600 transition-colors" /> WhatsApp Us
          </a>
        </div>
        ...
        {isOpen && (
          ...
          >
            <div className="flex flex-col px-5 py-6 gap-2">
              ...
              <a href={WA_LINK} target="_blank" rel="noopener noreferrer" onClick={() => setIsOpen(false)} className="px-5 py-4 mt-2 rounded-xl text-center font-bold bg-white/10 border border-white/20 text-white active:bg-white active:text-black flex items-center justify-center gap-2 transition-all">
        ...
        >
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-orange-500/10 border border-orange-500/20 text-orange-400 text-xs sm:text-sm font-semibold backdrop-blur-sm shadow-[0_0_20px_rgba(249,115,22,0.15)]">
              <Sparkles className="w-3 h-3 sm:w-4 sm:h-4" /> Engineering Digital Excellence
            </div>
          </motion.div>
          ...
          <p className="max-w-2xl mx-auto text-base sm:text-lg md:text-xl text-neutral-400 mb-8 md:mb-12 leading-relaxed px-2">
            OntoRex builds high-performance websites, scalable mobile applications, and AI-powered solutions that drive real business growth for modern enterprises.
          </p>

          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full sm:w-auto px-4 sm:px-0">
            <a href={WA_LINK} target="_blank" rel="noopener noreferrer" className="relative w-full sm:w-auto px-8 py-4 sm:py-4 rounded-xl sm:rounded-full font-bold bg-white text-black hover:bg-neutral-200 transition-all flex items-center justify-center gap-2 group overflow-hidden shadow-[0_0_30px_rgba(255,255,255,0.15)] active:scale-95">
            ...
            <a href="#portfolio" className="w-full sm:w-auto px-8 py-4 sm:py-4 rounded-xl sm:rounded-full font-medium bg-neutral-900 border border-white/10 text-white hover:bg-neutral-800 transition-all active:scale-95 text-center">
              View Our Work
            </a>
          </div>
        </motion.div>
  ...
  return (
    <section className="py-8 md:py-12 relative border-t border-white/5 bg-neutral-950 overflow-hidden flex flex-col items-center">
      <FadeIn className="text-center mb-6 md:mb-10 w-full">
        <h2 className="text-xs md:text-sm font-semibold text-neutral-500 uppercase tracking-wider">Technologies We Master</h2>
      </FadeIn>
      <div className="w-full inline-flex flex-nowrap overflow-hidden [mask-image:_linear-gradient(to_right,transparent_0,_black_64px,_black_calc(100%-64px),transparent_100%)] md:[mask-image:_linear-gradient(to_right,transparent_0,_black_128px,_black_calc(100%-128px),transparent_100%)]">
        ...
        >
          {[...techStack, ...techStack].map((tech, idx) => (
            <div key={idx} className="flex items-center gap-3 md:gap-4 text-lg md:text-2xl font-bold text-neutral-600 mx-6 md:mx-10 whitespace-nowrap hover:text-white transition-all cursor-default group">
              <img 
                src={tech.icon} 
                alt={tech.name} 
                ...
                loading="lazy" 
              />
              <span className="group-hover:text-orange-400 transition-colors duration-300">{tech.name}</span>
            </div>
          ))}
        </motion.div>
      </div>
...
const Services = () => {
  return (
    <section id="services" className="py-16 md:py-24 relative z-10 border-t border-white/5 bg-neutral-950">
      <div className="container mx-auto px-4 sm:px-6 lg:px-12">
        <FadeIn className="text-center max-w-3xl mx-auto mb-12 md:mb-20">
          <h2 className="text-sm font-semibold text-orange-400 uppercase tracking-wider mb-2 md:mb-3">Our Expertise</h2>
          <h3 className="text-3xl md:text-5xl font-bold text-white mb-4 md:mb-6">Digital Solutions that Scale</h3>
          <p className="text-neutral-400 text-sm md:text-lg px-2">We provide end-to-end services to take your brand from concept to market leader.</p>
        </FadeIn>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          {services.map((service, idx) => (
            <FadeIn key={idx} delay={idx * 0.1}>
              <motion.div 
                whileHover={{ y: -8 }}
                className="p-6 md:p-8 rounded-[2rem] bg-neutral-900/30 border border-white/5 md:hover:border-orange-500/40 md:hover:bg-neutral-900/60 transition-all duration-500 group h-full relative overflow-hidden shadow-lg md:hover:shadow-[0_0_40px_rgba(249,115,22,0.15)] cursor-pointer"
              >
                {/* Glowing Top Border Effect */}
                <div className="absolute top-0 left-0 w-full h-[2px] bg-gradient-to-r from-transparent via-orange-500 to-transparent opacity-0 md:group-hover:opacity-100 transform -translate-x-full md:group-hover:translate-x-0 transition-all duration-700 ease-out" />
                
                {/* Subtle Ambient Radial Background */}
                <div className={`absolute -inset-20 bg-gradient-to-br ${service.color} opacity-0 md:group-hover:opacity-[0.04] blur-3xl transition-opacity duration-500 rounded-full pointer-events-none`} />
                
                <div className="w-12 h-12 md:w-16 md:h-16 rounded-2xl bg-neutral-950 border border-white/10 flex items-center justify-center text-white mb-6 md:mb-8 md:group-hover:scale-110 md:group-hover:border-orange-500/50 md:group-hover:text-orange-400 transition-all duration-500 shadow-xl md:group-hover:shadow-[0_0_20px_rgba(249,115,22,0.2)] relative z-10">
                  {service.icon}
                </div>
                
                <h4 className="text-xl md:text-2xl font-bold text-white mb-3 md:mb-4 md:group-hover:text-orange-400 transition-colors duration-300 relative z-10">{service.title}</h4>
                <p className="text-neutral-400 text-sm md:text-base leading-relaxed mb-6 md:mb-8 relative z-10">{service.description}</p>
                
                <div className="flex items-center text-sm font-bold text-neutral-500 md:group-hover:text-orange-400 transition-colors cursor-pointer mt-auto uppercase tracking-wider relative z-10">
                  Explore <ArrowRight className="w-4 h-4 ml-2 opacity-100 md:opacity-0 md:-translate-x-4 md:group-hover:opacity-100 md:group-hover:translate-x-0 transition-all duration-500" />
                </div>
              </motion.div>
            </FadeIn>
          ))}
...
const About = () => {
  ...
  return (
    <section id="about" className="py-16 md:py-24 relative border-t border-white/5 bg-neutral-950 overflow-hidden">
      <div className="container mx-auto px-4 sm:px-6 lg:px-12">
        <div className="grid lg:grid-cols-2 gap-12 md:gap-16 items-center">
            ...
            <div className="relative max-w-md mx-auto lg:max-w-none">
              ...
              >
                <div className="flex items-center gap-3 md:gap-4">
                  ...
                  <div>
                    <p className="text-xl md:text-3xl font-bold text-white">5.0</p>
                    <p className="text-xs md:text-sm text-neutral-400">Average Rating</p>
                  </div>
                </div>
              </motion.div>
            </div>
          ...
          <FadeIn delay={0.1}>
            <h2 className="text-sm font-semibold text-orange-400 uppercase tracking-wider mb-2 md:mb-3 mt-8 lg:mt-0">Why Choose Us</h2>
            <h3 className="text-3xl md:text-5xl font-bold text-white mb-4 md:mb-6">Built for founders who demand excellence.</h3>
            <p className="text-neutral-400 text-sm md:text-lg mb-6 md:mb-8 leading-relaxed">
              We don't just build software; we build businesses. OntoRex partners with visionary brands to deliver digital solutions that solve real problems, drive growth, and leave a lasting impression.
            </p>
            ...
            <div className="space-y-3 md:space-y-4 mb-8 md:mb-10">
              {benefits.map((benefit, idx) => (
                <div key={idx} className="flex items-center gap-2 md:gap-3">
                  ...
                  <span className="text-neutral-300 text-sm md:text-base">{benefit}</span>
                </div>
              ))}
            </div>
            ...
            <div className="grid grid-cols-2 gap-4 md:gap-6 pt-6 md:pt-8 border-t border-white/10">
              <motion.div initial={{ opacity: 0, y: 10 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
                <p className="text-3xl md:text-4xl font-bold text-white mb-1"><CountUp end={150} />+</p>
                <p className="text-xs md:text-sm text-neutral-400">Projects Shipped</p>
              </motion.div>
              <motion.div initial={{ opacity: 0, y: 10 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.1 }}>
                <p className="text-3xl md:text-4xl font-bold text-white mb-1"><CountUp end={99} />%</p>
                <p className="text-xs md:text-sm text-neutral-400">Client Retention</p>
              </motion.div>
            </div>
          </FadeIn>
        </div>
...
const WorkProcess = () => {
  const steps = [
    { icon: <Zap className="w-5 h-5 md:w-6 md:h-6" />, title: "1. Discovery", desc: "Analyze business goals and plan optimal strategy." },
    { icon: <PenTool className="w-5 h-5 md:w-6 md:h-6" />, title: "2. Design", desc: "Crafting intuitive, high-converting interfaces." },
    { icon: <Code className="w-5 h-5 md:w-6 md:h-6" />, title: "3. Development", desc: "Clean, scalable code using modern frameworks." },
    { icon: <Rocket className="w-5 h-5 md:w-6 md:h-6" />, title: "4. Launch", desc: "Rigorous testing and a smooth deployment." }
  ];
    ...
    <section className="py-16 md:py-24 relative border-t border-white/5 bg-neutral-950">
      <div className="container mx-auto px-4 sm:px-6 lg:px-12">
        <FadeIn className="text-center max-w-3xl mx-auto mb-10 md:mb-16">
          <h2 className="text-sm font-semibold text-orange-400 uppercase tracking-wider mb-2 md:mb-3">How We Work</h2>
          <h3 className="text-3xl md:text-5xl font-bold text-white mb-4 md:mb-6">A Streamlined Process</h3>
        </FadeIn>
          ...
          {steps.map((step, idx) => (
            <FadeIn key={idx} delay={idx * 0.1}>
              <div className="relative p-5 md:p-6 rounded-2xl bg-neutral-900/40 border border-white/5 md:hover:border-orange-500/50 transition-colors h-full group z-10 backdrop-blur-sm shadow-md">
                ...
                <h4 className="text-lg md:text-xl font-bold text-white mb-2 md:group-hover:text-orange-400 transition-colors">{step.title}</h4>
    ...
    <section className="py-16 md:py-32 relative border-t border-white/5 bg-neutral-950 overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
        <FadeIn className="text-center max-w-3xl mx-auto mb-16 md:mb-24">
          <h2 className="text-xs md:text-sm font-bold text-orange-400 uppercase tracking-widest mb-2 md:mb-3">Core Values</h2>
          <h3 className="text-3xl md:text-6xl font-black text-white tracking-tight leading-tight">
            Why leading brands<br/>
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-yellow-500">trust us.</span>
          </h3>
        </FadeIn>
          ...
          {values.map((val, idx) => (
            <FadeIn key={idx} delay={idx * 0.2}>
              <div className={`relative group ${idx === 1 ? 'md:mt-16' : ''}`}>
                ...
                <div className={`absolute inset-0 ${val.glow} blur-2xl md:blur-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-full`} />
                ...
                <div className="relative h-full p-8 md:p-10 rounded-3xl bg-neutral-900/50 border border-white/5 backdrop-blur-xl md:hover:border-orange-500/30 transition-all duration-500 overflow-hidden shadow-2xl md:hover:-translate-y-2">
                  ...
                  <h4 className="text-xl md:text-2xl font-bold text-white mb-3 md:mb-4 relative z-10 group-hover:text-orange-400 transition-colors duration-300">{val.title}</h4>
                  <p className="text-neutral-400 text-sm md:text-base leading-relaxed relative z-10">{val.desc}</p>
...
const Portfolio = () => {
  ...
  return (
    <section id="portfolio" className="py-16 md:py-32 relative border-t border-white/5 bg-neutral-950 overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 md:mb-20 gap-6">
          <FadeIn className="max-w-2xl">
            ...
            <h2 className="text-4xl md:text-6xl font-black text-white tracking-tight leading-tight">
              Work that <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-yellow-500">speaks</span> for itself.
            </h2>
          </FadeIn>
            ...
            {filteredPortfolio.map((item) => (
              ...
              >
                ...
                <div className="absolute bottom-8 left-6 right-6 transition-all duration-500 md:group-hover:opacity-0 md:group-hover:translate-y-4 z-10 md:block flex flex-col justify-end h-full md:h-auto">
                  <p className="text-orange-400 text-xs font-bold uppercase tracking-widest mb-2 md:hidden">{item.category}</p>
                  <h4 className="text-2xl md:text-3xl font-black text-white drop-shadow-lg leading-tight">{item.title}</h4>
                </div>
                ...
                <div className="absolute bottom-4 left-4 right-4 md:bottom-6 md:left-6 md:right-6 p-6 rounded-2xl bg-neutral-950/80 backdrop-blur-xl border border-white/10 transform translate-y-8 opacity-0 md:group-hover:translate-y-0 md:group-hover:opacity-100 transition-all duration-500 ease-out md:group-hover:shadow-[0_0_30px_rgba(249,115,22,0.15)] z-20 hidden md:block">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {item.tech.map((t, i) => (
                      <span key={i} className="px-3 py-1 bg-white/5 border border-white/10 text-neutral-300 rounded-md text-[10px] md:text-xs font-medium">
                        {t}
                      </span>
                    ))}
                  </div>
        ...
        <div className="mt-12 md:mt-20 text-center">
          <a href="#" className="inline-flex items-center justify-center gap-3 text-white font-bold transition-all group px-8 py-4 rounded-2xl bg-neutral-900 border border-white/10 hover:border-orange-500 hover:bg-orange-500/10 hover:shadow-[0_0_30px_rgba(249,115,22,0.15)] w-full sm:w-auto active:scale-95">
            Explore All Projects <ArrowRight className="w-5 h-5 text-orange-500 group-hover:translate-x-1 group-hover:text-white transition-all" />
          </a>
        </div>
      </div>
    </section>
...
const Team = () => {
  return (
    <section id="team" className="py-16 md:py-24 relative border-t border-white/5 bg-neutral-950 overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
        <FadeIn className="text-center max-w-3xl mx-auto mb-10 md:mb-16">
          <h2 className="text-sm font-semibold text-orange-400 uppercase tracking-wider mb-2 md:mb-3">The Minds Behind</h2>
          <h3 className="text-3xl md:text-5xl font-bold text-white mb-4 md:mb-6">Meet our elite team</h3>
        </FadeIn>
              ...
              <div className="relative h-[400px] md:h-[480px] rounded-3xl overflow-hidden group shadow-lg md:hover:shadow-[0_0_30px_rgba(249,115,22,0.15)] transition-shadow">
                ...
                <div className="absolute bottom-4 left-4 right-4 md:bottom-6 md:left-6 md:right-6">
                  <div className="relative p-5 md:p-6 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-md overflow-hidden transform md:translate-y-12 md:group-hover:translate-y-0 transition-all duration-500 md:hover:border-orange-500/50">
                    ...
                    <h4 className="text-xl md:text-2xl font-bold text-white mb-1 relative z-10">{member.name}</h4>
                    <p className="text-orange-400 text-xs md:text-sm font-medium mb-2 relative z-10">{member.role}</p>
                    ...
                    <div className="flex items-center gap-3 mt-4 md:mt-5 md:opacity-0 md:group-hover:opacity-100 transform md:translate-y-4 md:group-hover:translate-y-0 transition-all duration-500 md:delay-200">
                      <a href="#" className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center text-white hover:bg-orange-500 hover:scale-110 transition-all">
...
const Testimonials = () => {
  return (
    <section id="testimonials" className="py-16 md:py-24 relative border-t border-white/5 bg-neutral-950 overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-12 relative z-10 mb-10 md:mb-16">
        <FadeIn className="text-center max-w-3xl mx-auto">
          <h2 className="text-sm font-semibold text-orange-400 uppercase tracking-wider mb-2 md:mb-3">Client Love</h2>
          <h3 className="text-3xl md:text-5xl font-bold text-white mb-4 md:mb-6">Don't just take our word for it.</h3>
        </FadeIn>
      </div>
      ...
      <div className="w-full inline-flex flex-nowrap overflow-hidden [mask-image:_linear-gradient(to_right,transparent_0,_black_32px,_black_calc(100%-32px),transparent_100%)] md:[mask-image:_linear-gradient(to_right,transparent_0,_black_128px,_black_calc(100%-128px),transparent_100%)] relative z-10 pb-6 md:pb-10 cursor-grab active:cursor-grabbing">
        ...
        >
          {[...testimonials, ...testimonials].map((testimonial, idx) => (
            <div key={idx} className="w-[280px] sm:w-[350px] md:w-[450px] p-6 md:p-8 rounded-2xl md:rounded-3xl bg-neutral-900/60 backdrop-blur-md border border-white/10 flex flex-col md:hover:border-orange-500/40 transition-all shrink-0 md:hover:-translate-y-2 duration-300 shadow-lg">
              ...
              <div className="flex items-center gap-3 md:gap-4 mt-auto pt-4 md:pt-6 border-t border-white/10">
                ...
                <div>
                  ...
                  <p className="text-xs md:text-sm text-neutral-400">{testimonial.role}</p>
                </div>
              </div>
            </div>
          ))}
...
const FAQ = () => {
  ...
  return (
    <section id="faq" className="py-16 md:py-32 relative border-t border-white/5 bg-neutral-950 overflow-hidden">
      {/* Decorative Glows */}
          ...
          <div className="lg:col-span-5 lg:sticky lg:top-32 lg:pb-16">
            <FadeIn>
              ...
              <p className="text-neutral-400 text-sm md:text-lg mb-8 md:mb-10 leading-relaxed max-w-md">
                Everything you need to know about our processes, timelines, and how we deliver world-class digital products.
              </p>
              ...
              <div className="hidden lg:block p-6 rounded-3xl border border-white/10 bg-neutral-900/50 backdrop-blur-sm max-w-sm relative overflow-hidden group">
                 ...
                 <h4 className="text-white font-bold text-lg mb-2 relative z-10">Still have questions?</h4>
                 <p className="text-neutral-400 text-sm mb-6 relative z-10">Can't find the answer you're looking for? Reach out to our team.</p>
                 <a href={WA_LINK} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 w-full py-3 rounded-xl bg-white text-black font-bold hover:bg-orange-500 hover:text-white transition-colors relative z-10 active:scale-95">
              ...
              return (
                <FadeIn key={idx} delay={idx * 0.1}>
                  ...
                  >
                    ...
                    >
                      <span className={`text-base md:text-xl font-bold pr-6 transition-colors duration-300 ${isOpen ? 'text-orange-400' : 'text-white group-hover:text-orange-300'}`}>
                        {faq.question}
                      </span>
                      <div className={`shrink-0 w-8 h-8 md:w-12 md:h-12 rounded-full flex items-center justify-center transition-all duration-500 ${isOpen ? 'bg-orange-500 text-white rotate-180 shadow-lg shadow-orange-500/25' : 'bg-white/5 text-neutral-400 group-hover:bg-white/10 group-hover:text-white'}`}>
          ...
          <div className="lg:hidden mt-8 w-full">
             <FadeIn>
               <div className="p-6 rounded-2xl border border-white/10 bg-neutral-900/50 text-center">
                 ...
                 <p className="text-neutral-400 text-sm mb-5">Reach out directly to our team.</p>
                 <a href={WA_LINK} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 w-full py-3 rounded-xl bg-orange-500 text-white font-bold active:scale-95 transition-transform">
                   <MessageCircle className="w-4 h-4" /> Let's Chat
                 </a>
               </div>
             </FadeIn>
...
const CTA = () => {
  return (
    <section id="contact" className="py-16 md:py-32 relative border-t border-white/5 bg-neutral-950 overflow-hidden px-4 md:px-0">
            ...
            <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center">
              ...
              <div className="flex items-center gap-3 bg-white/5 border border-white/10 px-4 py-2 rounded-full mb-8 backdrop-blur-md shadow-lg">
                <div className="flex -space-x-3">
                  <img className="w-8 h-8 rounded-full border-2 border-neutral-900 object-cover" src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&q=80&w=100" alt="Avatar" />
                  <img className="w-8 h-8 rounded-full border-2 border-neutral-900 object-cover" src="https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&q=80&w=100" alt="Avatar" />
                  <img className="w-8 h-8 rounded-full border-2 border-neutral-900 object-cover" src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&q=80&w=100" alt="Avatar" />
                </div>
                <span className="text-xs md:text-sm font-medium text-neutral-300">Join <span className="text-white font-bold">150+</span> happy founders</span>
              </div>

              <h2 className="text-4xl sm:text-5xl md:text-7xl font-black text-white mb-6 tracking-tight leading-tight">
                Ready to <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-yellow-500">scale</span> your business?
              </h2>
              <p className="text-base md:text-xl text-neutral-400 mb-10 md:mb-12 font-medium px-2 max-w-2xl mx-auto">
                Let's discuss how OntoRex can help you achieve your digital goals. Reach out instantly via WhatsApp and let's build something amazing.
              </p>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 md:gap-6 w-full sm:w-auto px-4 sm:px-0">
                <div className="relative w-full sm:w-auto">
                  ...
                  <a href={WA_LINK} target="_blank" rel="noopener noreferrer" className="relative w-full sm:w-auto px-8 py-4 md:px-10 md:py-5 rounded-full font-bold bg-white text-black hover:bg-neutral-200 transition-colors text-base md:text-lg flex items-center justify-center gap-3 active:scale-95 shadow-xl">
                    <WhatsAppIcon className="w-6 h-6 md:w-7 md:h-7 text-green-500" />
                    Start Your Project
                  </a>
                </div>
                <a href="mailto:ontorex.official@gmail.com" className="w-full sm:w-auto px-8 py-4 md:px-10 md:py-5 rounded-full font-bold bg-neutral-950 border border-white/20 text-white hover:bg-white/10 hover:border-white/40 transition-all text-base md:text-lg text-center active:scale-95">
                  Send an Email
                </a>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-12 mb-12 md:mb-16">
          <div className="lg:col-span-1">
            <a href="#" className="flex items-center gap-2 mb-4 md:mb-6 group">
              ...
              <span className="text-xl md:text-2xl font-black tracking-tight text-white">OntoRex</span>
            </a>
            ...
            <div className="flex gap-3 md:gap-4">
              <a href={FB_LINK} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-neutral-900 border border-white/10 flex items-center justify-center text-neutral-400 hover:text-white hover:bg-orange-500 hover:border-orange-500 transition-all">
                <FacebookIcon className="w-4 h-4" />
              </a>
              <a href="#" className="w-10 h-10 rounded-full bg-neutral-900 border border-white/10 flex items-center justify-center text-neutral-400 hover:text-white hover:bg-orange-500 hover:border-orange-500 transition-all">
                <LinkedinIcon className="w-4 h-4" />
              </a>
              <a href="https://github.com/ontorexofficial" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-neutral-900 border border-white/10 flex items-center justify-center text-neutral-400 hover:text-white hover:bg-orange-500 hover:border-orange-500 transition-all">
                <GithubIcon className="w-4 h-4" />
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 md:space-y-4">
              {['Web Development', 'Mobile Apps', 'UI/UX Design', 'Digital Marketing'].map(item => (
                <li key={item}><a href="#" className="text-neutral-400 hover:text-orange-400 transition-colors text-sm font-medium">{item}</a></li>
              ))}
            </ul>
          </div>
          ...
          <div>
            <h4 className="text-white font-bold text-base md:text-lg mb-3 md:mb-6">Subscribe to Newsletter</h4>
            <p className="text-neutral-400 text-xs md:text-sm mb-4">Get the latest insights on tech and design.</p>
            <div className="flex gap-2">
               <input type="email" placeholder="Email address" className="bg-neutral-900 border border-white/10 rounded-lg md:rounded-xl px-4 py-2 w-full text-sm text-white focus:outline-none focus:border-orange-500 transition-colors" />
               <button className="bg-orange-500 hover:bg-orange-600 text-white px-4 py-2 rounded-lg md:rounded-xl transition-colors"><Send className="w-4 h-4"/></button>
            </div>
            <ul className="space-y-3 md:space-y-4 text-xs md:text-sm text-neutral-400 mt-6">
              <li>
                <a href={WA_LINK} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-orange-400 transition-colors font-medium">
                  <WhatsAppIcon className="w-4 h-4 text-green-500" /> +880 1873 189853
                </a>
              </li>
              <li className="flex items-center gap-2 font-medium"><Mail className="w-4 h-4 text-orange-400"/> ontorex.official@gmail.com</li>
            </ul>
          </div>
        </div>
